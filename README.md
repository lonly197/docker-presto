...
# build docker image
docker build --rm --build-arg BUILD_DATE=${date +'%m/%d/%Y'} VERSION=0.178 HIVE_METASTORS_URI=thrift://dmp2:9083 -t lonly197/presto:v0.178 https://github.com/lonly197/docker-presto.git
