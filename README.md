...
docker run -p 8200:8080 -v /data00/docker-presto:/presto --name presto -d lonly/presto:0.187 coordinator

# run container for presto-server-worker
docker run -p 8200:8080 -v /data00/docker-presto:/presto --name presto -d lonly/presto:0.187 worker
